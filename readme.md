# HDI_IMAPMailSearching 

How do I search for specific emails via IMAP? (4D v18 R5)

Find more information on the [blog post](https://blog.4d.com/search-emails-with-imap-protocol/).
